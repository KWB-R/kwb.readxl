...
`"<0.0001"` further down. In the returned data frame the text values are
removed, i.e. set to `NA`. This package avoids these data losses as it keeps the
original (text) information and lets the user decide what to do.
