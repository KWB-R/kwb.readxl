...
contains text values, such as `">1000"`. In these cases the readxl functions 
return a data frame in whith the text values are removed, i.e. set to `NA`. This 
package avoids these data losses as it keeps the original (text) information and 
...
assumed to be numeric (double \<dbl\>) even though it contains a text value in row
1004 (see image above).
